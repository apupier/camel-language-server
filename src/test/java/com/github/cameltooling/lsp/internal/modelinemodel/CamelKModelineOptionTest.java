...
class CamelKModelineOptionTest {
	...
	void testOptionTraitWithIncompleteTraitContent() throws Exception {
		...
		List<CamelKModelineOption> options = new CamelKModeline(null, modelineWithMixedSeparator).getOptions();
	...
	private void checkFor2Options(String modelineWith2Options) {
		List<CamelKModelineOption> options = new CamelKModeline(null, modelineWith2Options).getOptions();
		assertThat(options).hasSize(2);
